  ...
  const demoMessages = [
    {
      id: '1',
      sender: 'SYSTEM',
      message: '◊-VOID-◊ has gained access. Welcome to the collective.',
      timestamp: '08:01'
    },
    {
      id: '2',
      sender: 'SYSTEM',
      message: 'Ω-DAWN-Ω has gained access. Welcome to the collective.',
      timestamp: '11:17'
    },
    {
      id: '3',
      sender: 'SYSTEM',
      message: '⌂-CR0SS-⌂ has gained access. Welcome to the collective.',
      timestamp: '16:42'
    },
    {
      id: '4',
      sender: 'SYSTEM',
      message: '△-APEX-△ has gained access. Welcome to the collective.',
      timestamp: '22:19'
    }
  ];
