  ...
  const demoMessages = [
    {
      id: '1',
      sender: '⌂-CR0SS-⌂',
      message: 'My claiming process is complete. Verification was immediate after scanning the embedded chip.',
      timestamp: '14:22'
    },
    {
      id: '2',
      sender: '△-APEX-△',
      message: 'Similar experience. Time distortion followed by clarity. Anyone else experience physical changes?',
      timestamp: '14:36'
    },
    {
      id: '3',
      sender: 'Ω-DAWN-Ω',
      message: 'Yes. Enhanced sensitivity to specific frequencies. Also recurring symbol visions during sleep cycle.',
      timestamp: '14:40'
    }
  ];
